...
async def draw_gacha_img(user_id: str, pool: str, num: int, nickname: str):
    ...
    for _ in range(num):
        ...
        draw.text((27, 575 - 30), f'@{nickname} {time_str}  Created By LittlePaimon',
                  font=font_manager.get('hywh.ttf', 20), fill="#8E8E8E")
        images.append(img)
    return images
